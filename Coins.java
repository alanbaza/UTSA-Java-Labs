 ...
 * 
 * 1) User inputs number of quarters, dimes, nickels and pennies then the program outputs
 * the total number of coins along with the total dollar amount.
 * 
 * 2) User inputs number of cents and the program outputs the least amount of coins
 *  needed to form the inputed amount.
 */
